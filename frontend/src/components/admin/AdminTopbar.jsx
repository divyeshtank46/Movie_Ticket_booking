...
const AdminTopbar = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    return (
        <div className="fixed top-0 left-0 right-0 h-16 bg-black/40 backdrop-blur-xl border-b border-white/10 z-30">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center gap-3 ml-2 pl-2 border-l border-white/20
                        ...
                        >
                            ...
                            <div className="w-8 h-8 rounded-full bg-linear-to-r from-red-600 to-purple-600 
                        ...
                        {showProfileMenu && (
                            <>
                                ...
                                />
                                <div className="absolute right-0 mt-2 w-48 bg-black/90 backdrop-blur-xl 
                                    border border-white/10 rounded-xl shadow-2xl z-50 overflow-hidden">
                                    <div className="p-3 border-b border-white/10">
                                        <p className="text-sm font-medium"></p>{user.Name}
